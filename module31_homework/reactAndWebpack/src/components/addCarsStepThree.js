...
class addCarsStepThree extends React.Component {
    constructor(props){
        super(props)
        this.onDrop = (data) => {
    ...
    submit = event => {
        const data = {photosAuto:[...this.state.files]}
    ...
    render(){
        ...
        return (
            <main>
                ...
                <p className='b-main-addCars-steps'>Шаг 3 из 4</p>
                <h2 className='b-main-addCars-headline'>Фото автомобиля</h2>
                <p className='b-main-addCars-photos-headline'>Чем больше качественных фотографий вы загрузите, тем выше шанс того, что выберут ваш автомобиль.</p>
...
export default withRouter(connect(null, mapDispatchToProps)(addCarsStepThree));
