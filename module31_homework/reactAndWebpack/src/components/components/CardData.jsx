...
export const CardData = ({ car }) => {
    ...
    return (
        <>
            <div className='m-car-back' onClick={goBack}>
                <img src={back}/>
                <p>Назад</p>
            </div>
            <div className='m-car-photos'>
                ...
                <div className='m-car-photos-morephoto'>
                    <img className='m-car-photos-morephoto-onephoto' src={carPic} />
            ...
            <div className='m-car-description'>
                <div className='m-car-description-characteristics'>
                    <h4>{car.brand} {car.model}, {car.yearIssue}</h4>
                    <div className='m-car-description-characteristics-prices'>
                        <div className='m-car-description-characteristics-prices-rent'>
                            <p className='m-car-description-characteristics-prices-rent-price'>{car.PriceOne}</p>
                        ...
                        <div className='m-car-description-characteristics-prices-3daysrent'>
                            <p className='m-car-description-characteristics-prices-rent-price'>{car.PriceTwo}</p>
                        ...
                        <div className='m-car-description-characteristics-prices-more5daysrent'>
                            <p className='m-car-description-characteristics-prices-rent-price'>{car.PriceThree}</p>
